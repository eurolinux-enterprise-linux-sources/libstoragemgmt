...
%{?_with_python3: %global with_python3 1 }
%{?_without_python3: %global with_python3 0 }
...
# Argparse is included in newer versions, only require for RHEL6
...
The python3-%{libstoragemgmt}-clibs package contains python client C extension
libraries.
...
Requires:       %{libstoragemgmt} = %{version}-%{release}
BuildArch:      noarch
Requires:       python3-%{libstoragemgmt}-clibs
...
The python3-%{libstoragemgmt}-clibs package contains python 3 client C extension
libraries.
%endif
...
Requires:       python3-%{libstoragemgmt} = %{version}-%{release}
%else
...
%files -n python3-%{libstoragemgmt}-clibs
...
%{python_sitelib}/lsm/plugin/smispy/WBEM.*
%{python_sitelib}/lsm/plugin/smispy/lmiwbem_wrap.*
%endif
...
* Tue Aug 2 2016 Tony Asleson <tasleson@redhat.com> 1.3.4-1
- Bug fixes:
  * https://github.com/libstorage/libstoragemgmt/pull/177

* Fri Jul 29 2016 Tony Asleson <tasleson@redhat.com> 1.3.3-1
- Bug fixes:
