...
Patch2:         0003-ONTAP-plugin-SSL-fix.patch
Patch3:         0001-LocalDisk-Fix-incorrect-VPD-query-for-0x89-and-0xb1.patch
...
%patch2 -p1 -b ontap_ssl
%patch3 -p1 -b mptsas_crash
